...
def gm_dashboard(request , y , q):
    if request.user.is_authenticated:
        ...
        # السنوات
            ...
            years = list(range(current_year, current_year + 10))  # السنوات من السنة الحالية ولمدة 10 سنوات قادمة
            data = {
...
def calc_departmet(request ,id , y , q):
    ...
    for s in sections:
        ...
        percentage = calculate_percentage_for_orders(get_orders_by_company(request.session['company_id'] ,y , q) , listdept)
        row = {
