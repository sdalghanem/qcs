...
path('regions_rate/<str:id>/<str:y>/<str:q>' , brands_view.regions_rate , name='regions_rate'),
path('cities_rate/<str:id>/<str:brand_id>/<str:y>/<str:q>' , brands_view.cities_rate , name='cities_rate'),
path('districts_rate/<str:id>/<str:brand_id>/<str:y>/<str:q>' , brands_view.districts_rate , name='districts_rate'),
path('branchs_rate/<str:id>/<str:brand_id>/<str:y>/<str:q>' , brands_view.branchs_rate , name='branchs_rate'),
path('reports_list/<str:id>/<str:y>/<str:q>' , brands_view.reports_list , name='reports_list'), 
...
path('departments_rate/<str:y>/<str:q>' , departments_view.departments_rate , name='departments_rate'),  
path('sections_rate/<str:id>/<str:y>/<str:q>' , departments_view.sections_rate , name='sections_rate'), 
path('terms_rate/<str:id>/<str:y>/<str:q>' , departments_view.terms_rate , name='terms_rate'),
# home
